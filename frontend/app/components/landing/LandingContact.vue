...
interface AcademyConfig {
  ...
  schedule?: { openingHours?: string | null };
  social?: {
...
<template>
  <section id="contato" class="relative py-24 overflow-hidden">
    ...
    <div
      class="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_center,_rgba(249,115,22,0.1),_transparent_60%)]"
    />
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6">
      ...
      <div class="grid lg:grid-cols-2 gap-12">
        <div
          class="rounded-3xl border border-white/10 bg-zinc-900/60 backdrop-blur-sm p-8"
        >
          <Transition mode="out-in" name="fade">
            ...
            >
              <div
                class="w-20 h-20 rounded-full bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center mb-6 shadow-xl shadow-orange-500/30"
              >
        ...
        <div class="space-y-6">
          ...
          >
            <div
              class="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center flex-shrink-0"
            >
