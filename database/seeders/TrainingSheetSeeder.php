...
class TrainingSheetSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $divisionTemplate = [
            'A' => [
                ['name' => 'Supino Reto com Barra', 'series' => 4, 'repetitions' => '8-10', 'rest_seconds' => 90],
                ['name' => 'Crucifixo na Máquina', 'series' => 3, 'repetitions' => '10-12', 'rest_seconds' => 60],
                ['name' => 'Tríceps Pulley', 'series' => 3, 'repetitions' => '10-12', 'rest_seconds' => 60],
            ],
            'B' => [
                ['name' => 'Puxada Frontal', 'series' => 4, 'repetitions' => '8-10', 'rest_seconds' => 90],
                ['name' => 'Remada Curvada com Barra', 'series' => 3, 'repetitions' => '10-12', 'rest_seconds' => 75],
                ['name' => 'Rosca Direta com Barra', 'series' => 3, 'repetitions' => '10-12', 'rest_seconds' => 60],
            ],
            'C' => [
                ['name' => 'Agachamento Livre', 'series' => 4, 'repetitions' => '8-10', 'rest_seconds' => 120],
                ['name' => 'Leg Press 45°', 'series' => 4, 'repetitions' => '10-12', 'rest_seconds' => 90],
                ['name' => 'Panturrilha em Pé na Máquina', 'series' => 4, 'repetitions' => '12-15', 'rest_seconds' => 45],
            ],
        ];
